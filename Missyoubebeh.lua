...
local Themes = {
    ...
    SpeedHubX = {
        Name = "SpeedHubX",
        Accent = Color3.fromRGB(200, 0, 0), -- strong red accent

        AcrylicMain = Color3.fromRGB(30, 30, 30),      -- darker background
        AcrylicBorder = Color3.fromRGB(50, 20, 20),    -- dark red border
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(35, 35, 35), Color3.fromRGB(20, 0, 0)),
        AcrylicNoise = 0.85,

        TitleBarLine = Color3.fromRGB(100, 0, 0),      -- red line
        Tab = Color3.fromRGB(50, 10, 10),              -- reddish tab

        Element = Color3.fromRGB(45, 0, 0),            -- red base for elements
        ElementBorder = Color3.fromRGB(80, 0, 0),      -- red border for elements
        InElementBorder = Color3.fromRGB(20, 20, 20),
        ElementTransparency = 0.82,

        ToggleSlider = Color3.fromRGB(200, 0, 0),      -- accent red on toggles
        ToggleToggled = Color3.fromRGB(240, 240, 240), -- white when toggled

        SliderRail = Color3.fromRGB(60, 60, 60),

        DropdownFrame = Color3.fromRGB(30, 30, 30),
        DropdownHolder = Color3.fromRGB(60, 20, 20),
        ...
        InputFocused = Color3.fromRGB(50, 10, 10),
        InputIndicator = Color3.fromRGB(200, 0, 0),

        Dialog = Color3.fromRGB(30, 30, 35),
        DialogHolder = Color3.fromRGB(60, 20, 20),
        DialogHolderLine = Color3.fromRGB(200, 0, 0),
        DialogButton = Color3.fromRGB(30, 30, 35),
        DialogButtonBorder = Color3.fromRGB(200, 0, 0),
